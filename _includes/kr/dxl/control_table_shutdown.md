...
위험 상황이 감지되면, {% if page.product_group=='dxl_ax' or page.product_group=='dxl_dx' or page.product_group=='dxl_ex' or page.product_group=='dxl_rx' or page.product_group=='dxl_mx' %} LED가 점멸하고 모터 출력은 0 [%]로 변경됩니다. {% elsif page.product_group=='dxl_pro_a' or page.product_group=='dxl_p' %} [Torque Enable(512)] 값이 ‘0’으로 변경되고 모터 출력은 0 [%]가 됩니다. {% elsif page.product_group=='dxl_pro' %} [Torque Enable(562)] 값이 ‘0’으로 변경되고 모터 출력은 0 [%]가 됩니다. {% else %} [Torque Enable(64)] 값이 ‘0’으로 변경되고 모터 출력은 0 [%]가 됩니다. {% endif %} 
...
| Bit 2 |  Overheating Error  | 내부 온도가 설정된 온도를 벗어난 경우                                                    |
...
| Bit 2 |   Overheating Error(기본값)    | 내부 온도가 설정된 온도를 벗어난 경우                                                                                          |
