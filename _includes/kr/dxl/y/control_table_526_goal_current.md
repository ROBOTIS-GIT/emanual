전류 제어 모드에서는 Goal Current(526) 값이 목표 전류 값으로 동작합니다. 속도 제어 모드, 위치 제어 모드 그리고 확장 위치 제어 모드에서는 전류 제어기 입력(전류)의 제한 값으로 동작됩니다. Goal Current(526)은 [Current Limit(66)] 보다 클 수 없습니다. 
