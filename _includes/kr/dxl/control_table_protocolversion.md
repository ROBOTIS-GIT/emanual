...
다이나믹셀의 프로토콜 타입을 설정할 수 있습니다.  
함께 사용할 장치의 프로토콜 타입에 맞춰서 설정하세요.

|    값     |                   프로토콜 타입                    |                       호환되는 장치                       |
|:---------:|:--------------------------------------------------:|:---------------------------------------------------------:|
| 2(초기값) | [다이나믹셀 프로토콜 2.0](#다이나믹셀-프로토콜-20)         |             [프로토콜 호환표]{: .popup} 참고              |
|    20     |              [S.BUS](#sbus-프로토콜)               | Futaba 와 FrSky 제품에서 사용하는 RC 규격의 통신 프로토콜 |
|    21     |               [iBUS](#ibus-프로토콜)               |     FlySky 제품에서 사용하는 RC 규격의 통신 프로토콜      |
|    22     |             [RC-PWM](#rc-pwm-프로토콜)             |             RC 서보모터에서 이용한는 PWM 신호             |
...
#### [다이나믹셀 프로토콜 2.0](#다이나믹셀-프로토콜-20)

다이나믹셀간의 데이터 통신을 위한 기본적인 통신 프로토콜 입니다. 

자세한 내용은 [프로토콜 2.0]을 참고하세요.

#### [S.Bus 프로토콜](#sbus-프로토콜)

Futaba와 FrSky의 RC 서보모터 제품에서 사용하는 통신 프로토콜 입니다.
- 최대 16개의 다이나믹셀을 공유 통신선으로 연결할 수 있으며, ID가 1~16로 설정되어 있을 경우에만 S.BUS 프로토콜로 동작이 가능합니다.
...
여러 장치가 신호선을 공유할 수 없으며, 가장 고전적이고 오랫동안 대중적으로 사용되고 있는 RC 서보모터의 프로토콜입니다. RC-PWM 신호는 다음과 같이 신호 펄스폭의 시간으로 통해서 데이터를 전송하는 방식으로, 시간에 대한 아날로그 데이터입니다.
...
**참고** : 
- [프로토콜 2.0](/docs/kr/dxl/protocol2/)은 [프로토콜 1.0](/docs/kr/dxl/protocol1/)의 문제점을 대폭 개선한 타입 입니다. 프로토콜 1.0을 사용할 경우, 컨트롤테이블의 일부 영역의 접근이 제한될 수 있습니다.
