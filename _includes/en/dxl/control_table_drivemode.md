{% if page.product_group=='dxl_x430' %}User can set Drive Mode of DYNAMIXEL by configuring the Bit of Drive Mode. Please read descriptions below about Drive Mode which is available from **firmware version 38**.
