...
```bash
ros2 launch turtlebot3_autorace_detect detect_traffic_light.launch calibration_mode:=True
```
...
7. In one window, select the `/detect/image_traffic_light/compressed` topic. In another window, select one of the four topics to view the masked images: `/detect/image_red_light`, `/detect/image_yellow_light`, `/detect/image_green_light`, `/detect/image_traffic_light`.
