...
8. Check `~/.ssh/known_hosts` file if SSH is successfully generated.
   ...
   ![known_hosts](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/known_hosts.png)
...
3. Select **/raspicam_node/image/compressed** (or **/raspicam_node/image/**) topic on the check box.
   ...
   ![camera view](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/camera_setting_01.png)
...
5. Click **raspicam_node**, and modify parameter value to see clear images from the camera.
   ...
   ![camera setting](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/camera_setting_02.png)
...
```
    ...
    **NOTE**: The size of squres may differ depending on the print paper size A3, A4 or others. In which case, **adjust the value (0.024) of --square option in the given command** according to the square size in the print paper.
    ...
    ![calibration display](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/camera_calibration_01.png)
...
3. Use the checkerboard to calibrate the camera, and click **CALIBRATE**.
   ...
   **NOTE**: Move and tilt the checker board around to the left, right, top, bottom and various angles to get `X`,`Y`, `Size` and `Skew` calibration data. As the data is computed enough, `X`,`Y`, `Size` and `Skew` will have a green bar.
   ...
   ![calibraion](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/camera_calibration_02.png)

4. Click **Commit** to save the intrinsic calibration data to the default folder.(~/.ros/camera_info)

   ![commit](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/camera_calibration_04.png)
...
4. Update a map with the keyboard controller.
   ...
   ![making_map](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/slam_02.png)
...
````
   ...
   ![map](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/map.png)
...
```
    ...
    **NOTE**: Be sure **Remote PC** and **TurtleBot3** are connected **under the same IP**.
    ...
    ![demo_01](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/home_service_challenge_demo_01.png)
...
1. Navigating to a target in the living room.
   - Find a target, and reach it using a Navigation package.  
    ...
    ![demo_02](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/home_service_challenge_demo_02.png)
...
2. Approaching the target.
   - For the approach to the target with precise, TurtleBot3 wheels are directly controlled by computing target's location from AR marker. (Used Topic : `/tb3_hsc/cmd_vel`). To produce a reliable performance, Closed-loop and control system can be used for the specified number of times.
    ...
    ![demo_03](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/home_service_challenge_demo_03.png)
...
3. Picking the target with OpenMANIPULATOR-X's gripper.
   - Pick the target object using the moveit package (Joint space control, Task space control and Gripper control)
    ...
    ![demo_04](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/home_service_challenge_demo_04.png)
...
5. Navigating to the place where the object will be placed.
   - Find a next target, and reach it using a Navigation package.
    ...
    ![demo_05](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/home_service_challenge_demo_05.png)
...
8. Returning to the starting point using the navigation package.
   ...
   ![demo_06](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/home_service_challenge_demo_06.png)
...
```
   ...
   ![gazebo](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/simulation_00.png)
...
```
   ...
   ![simulation_rviz](/assets/images/platform/turtlebot3/mainpulation/home_service_challenge/kinetic/simulation_rviz_01.png)
