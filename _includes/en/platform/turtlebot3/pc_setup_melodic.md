...
Download and install the `Ubuntu 18.04` on the `Remote PC (your desktop or laptop PC)` from the following link.
...
- [Manual installation of ROS 1 Melodic](http://wiki.ros.org/melodic/Installation/Ubuntu)
