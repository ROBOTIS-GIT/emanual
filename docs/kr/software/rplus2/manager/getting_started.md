...
layout: archive
lang: kr
ref: rplusmanager2_getting_started
read_time: true
share: true
author_profile: false
permalink: /docs/kr/software/rplus2/manager/getting_started/
sidebar:
  title: R+Manager 2.0
  nav: "rplusmanager2"
---
...
![](/emanual/assets/images/sw/rplus2/rplusmanager2_01.jpg)
...
![](/emanual/assets/images/sw/rplus2/rplusmanager2_02.jpg)
...
![](/emanual/assets/images/sw/rplus2/rplusmanager2_03.jpg)
...
![](/emanual/assets/images/sw/rplus2/rplusmanager2_04.jpg)
...
![](/emanual/assets/images/sw/rplus2/rplusmanager2_05.jpg)

아래 그림은 컨트롤 테이블을 테스트하는 화면입니다. 검색된 제품을 통신속도, 모델에 따라 분류하여 나타내며, 컨트롤 테이블 값을 수정하며 테스트해볼 수 있습니다.

![](/emanual/assets/images/sw/rplus2/rplusmanager2_06.jpg)
...
1. 홈 탭에서 업데이트 및 테스트를 진행할 제품을 선택합니다. (예시에서는 ROBOTIS MINI를 선택함)
    ...
    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_07.jpg)

2. “업데이트 및 테스트” 메뉴를 선택합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_08.jpg)
 
3. 안내에 따라 제품과 PC를 연결한 후 제품을 켭니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_09.jpg)

4. 연결할 포트를 선택한 후 “다음”버튼을 클릭합니다. (예시에서는 블루투스 시리얼 포트를 사용함)

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_10.jpg)
 
5. 검색할 통신속도를 선택한 후 “다음”버튼을 클릭합니다.(블루투스 시리얼 포트 사용시 57600bps만 가능함)

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_11.jpg)

6. 관리할 대상이 정상적으로 검색되었는지 확인한 후 다음 버튼을 클릭합니다. (만약, 제품 검색이 정상적으로 이뤄지지 않을 경우 다시 시도 버튼을 클릭하세요.)

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_12.jpg)

7. 업데이트할 내용이 감지되면 아래의 “지금 업데이트” 버튼이 활성화됩니다. 업데이트 내용을 확인한 후 “지금 업데이트”버튼을 클릭합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_13.jpg)
 
8. 업데이트가 정상적으로 완료될 때까지 기다린 후, “다음” 버튼을 클릭합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_14.jpg)

9. 업데이트가 완료되면 “컨트롤 테이블 테스트” 기능이 실행됩니다. (일부 제어기는 업데이트 완료 후 전원이 꺼지며, 대화창이 종료됩니다.)

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_15.jpg)


## [컨트롤 테이블 테스트](#컨트롤-테이블-테스트)
...
2. 컨트롤 테이블 창은 장치를 통신속도, 장치, 순으로 분류합니다. 테스트할 통신속도 그룹과 장치를 선택합니다. (예시에서는 XL-320을 선택함.)
    ...
    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_16.jpg)
...
3. 좌측 메뉴에서 “팩토리 리셋” 버튼을 클릭하면 제품을 공장 초기화 상태로 되돌릴 수 있습니다. (이때, ID와 Baudrate 값은 변경하지 않습니다.) 좌측 메뉴에서 “리부팅” 버튼을 클릭하면 해당 다이나믹셀을 재부팅할 수 있습니다. 좌측 메뉴에서 “토크 켜기” 버튼을 클릭하면 해당 다이나믹셀의 토크를 켜거나 끌 수 있습니다.
    ...
    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_17.jpg)
...
6. 우측 하단의 위치 값 컨트롤을 사용하여 모터를 움직여봅니다.(값을 조정하는 과정에서 모터가 갑작스럽게 움직일 수 있으니 주의하세요.)
    ...
    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_18.jpg)
...
9. 좌측 하단의 “하드웨어 알람” 메시지를 통해 하드웨어의 에러상태를 확인할 수 있습니다.
    ...
    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_19.jpg)
 
10. 일부 다이나믹셀의 경우 프로파일 타입 상태 보기 기능을 제공합니다. 특정 Operating Mode에서 Profile Acceleration 값과 Profile Velocity 값에 따라 프로파일 타입이 결정됩니다. 자세한 사항은 해당 다이나믹셀의 E-Manual을 참고하세요. (지원 가능한 제품 : XM시리즈와 XH시리즈)
    ...
    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_20.jpg)
...
1. 홈 탭에서 펌웨어 복구를 진행할 제품을 선택합니다. (예시에서는 ROBOTIS MINI를 선택함)
    ...
    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_21.jpg)

2. “펌웨어 복구” 메뉴를 선택합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_22.jpg)

3. 안내 메시지를 확인한 후 “다음” 버튼을 클릭하세요.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_23.jpg)

4. 복구를 진행할 제품을 선택한 후 “다음” 버튼을 클릭합니다. (예시에서는 OpenCM9.04를 선택함.)

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_24.jpg)
 
5. 안내를 순서대로 따라서 진행합니다. 노란색 경고 문구를 반드시 숙지하세요!
6. 모든 준비를 마치면 “다음” 버튼을 클릭합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_25.jpg)

7. 연결할 포트를 선택한 후 “다음”버튼을 클릭합니다. (예시에서는 블루투스 시리얼 포트를 사용함)

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_26.jpg)

8. 장치가 연결되면 펌웨어 설치를 위해 부트로더를 감지합니다. “다음” 버튼이 활성화되면 클릭합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_27.jpg)

9. 설치할 펌웨어 정보를 확인한 후 “다음” 버튼을 클릭합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_28.jpg)
 
10. 복구가 정상적으로 완료되면 “마침” 버튼을 클릭합니다.

    ![](/emanual/assets/images/sw/rplus2/rplusmanager2_29.jpg)
