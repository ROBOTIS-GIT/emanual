...
**소프트웨어 다운로드**  
[윈도우 (v2.0.2.0)](http://www.robotis.com/service/download.php?no=1670)  
[리눅스 (v2.0.2.0)](http://www.robotis.com/service/download.php?no=1671)  
[맥 (v2.0.2.0)](http://www.robotis.com/service/download.php?no=1760)  
...
1. 윈도우즈 전용 패키지를 다운로드 합니다.  
  - [윈도우즈 소프트웨어 다운로드 (v2.0.2.0)](http://www.robotis.com/service/download.php?no=1670)
2. 다운받은 설치파일을 실행합니다.  
...
1. 리눅스 설치패키지를 다운로드합니다.  
  - [리눅스 소프트웨어 다운로드 (v2.0.2.0)](http://www.robotis.com/service/download.php?no=1671)  
...
1. 맥 OS 설치 패키지를 다운로드 합니다.  
  - [맥 소프트웨어 다운로드 (v2.0.2.0)](http://www.robotis.com/service/download.php?no=1760)
