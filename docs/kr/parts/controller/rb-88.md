...
![](/assets/images/parts/controller/rb-88/rb_88_overview.jpg)

> RB-88 제어기

# [개요](#개요)

- 올로 AI에서 사용되는 제어기로, 블루투스기능과 각종 입출력장치 (적외선 센서, 마이크, LED, 부저)가 내장되어 있습니다.
...
![rb_88_label](/assets/images/parts/controller/rb-88/rb_88_label.jpg)
...
![rb_88_cross_hn](/assets/images/parts/controller/rb-88/rb_88_cross_hn.jpg)
...
4. 블루투스장치 선택 창에서 연결하려는 제어기를 선택후 페어링을 진행합니다.
    ...
    ![rb_88_pc_04_pairing](/assets/images/parts/controller/rb-88/rb_88_pc_04_pairing.jpg)
...
3. `로봇추가`를 클릭 후 연결하려는 제어기를 선택 합니다.
    ...
    ![rb_88_mob_add_rb](/assets/images/parts/controller/rb-88/rb_88_mob_add_rb.jpg)
...
2. RB-88 아이콘을 클릭 합니다.
    ...
    ![rb_88_icon](/assets/images/parts/controller/rb-88/rb_88_icon.jpg)
...
2. 조종기 아이콘을 선택하여 조종기를 실행 합니다.
    ...
    ![rb_88_control](/assets/images/parts/controller/rb-88/rb_88_control.jpg)
