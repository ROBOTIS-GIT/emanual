...
- RoboPlus Manager를 이용하여 CM-530, AX/MX Dynamixel 의 동작을 설정하거나 테스트하기 위해 사용합니다.
...
CM-530 에 배터리 소켓에 배터리를 연결하거나, 전원 공급기인 SMPS 를 전원잭 소켓에 연결하고 전원 스위치를 ON 으로 설정하면 전원이 인가됩니다. 전원이 인가되면 Power LED 가 켜지며, 모드 표시 LED 중 하나가 깜빡입니다.
 ...
 ![](/assets/images/parts/controller/cm-530/_mg_9745.jpg)
...
![](/assets/images/parts/controller/cm-530/_mg_9754.jpg)
...
![](/assets/images/parts/controller/cm-530/_mg_9753.jpg)
