...
- [R+ Manager] (1.0.30.0 이상 버전) 또는 [R+ Manager 2.0]를 통해 펌웨어 복구를 할 수 있습니다.
- [R+ Task] (1.1.0.0 이상 버전) 또는 [R+ Task 2.0]를 통해 제어용 태스크 코드를 작성하여 각 부품들의 동작을 제어할 수 있습니다.
...
> Micro USB 케이블과 CM-151 제어기 연결 그림

# [무선 통신 모듈 연결하기](#무선-통신-모듈-연결하기)

- CM-151은 BLE 통신이 가능하며, [BT-410 동글]과 호환됩니다. 
- CM-151이 스마트기기 또는 BT-410 동글등의 BLE Central Device (BLE 중앙 장치)와 연결되지 않았을경우, 파란색 LED가 깜밖입니다.
- CM-151이 BLE Central Device (BLE 중앙 장치)와 연결되었을 경우, 제어기의 파란색 LED가 깜밖이지 않고 게속 유지됩니다.
...
[R+ Manager]: /docs/kr/software/rplus1/manager/
