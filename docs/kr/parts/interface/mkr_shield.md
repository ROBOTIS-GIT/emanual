...
<sup>3</sup> 배터리 커넥터는 다음의 로보티즈 배터리와 호환됩니다. [LB-010](http://en.robotis.com/shop_en/item.php?it_id=903-0143-000) 또는 [LB-020](http://en.robotis.com/shop_en/item.php?it_id=903-0277-000).
{: .notice}
