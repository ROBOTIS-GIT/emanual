...
*Maximum Torque, Current는 순간적으로 사용 가능한 값입니다. 정격 이상의 토크, 전류를 지속 사용시 장치 보호를 위해 과부하 에러(Overload Error)가 발생합니다.
{: .notice}
...
[PDF]: https://www.robotis.com/service/download.php?no=2169
[DWG]: https://www.robotis.com/service/download.php?no=2170
