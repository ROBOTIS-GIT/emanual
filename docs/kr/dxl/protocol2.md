...
**참고** : Instruction packet 의 ID가 Broadcast ID(0xFE) 인 경우는 이 값에 상관 없이 [Status Packet](#status-packet)이 반환되지 않습니다. 
{: .notice}
...
|  P1  | P2 ~ P5                           | 설명                                                                                                                                                                                                                |
|:----:|:----------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0x01 | 고정값<br />(0x44 0x58 0x4C 0x22) | 현재위치 값 (Present Position)을 1 회전 (0~4096) 이내의 절대위치 값으로 초기화.<br />정지된 상태에서만 Clear 가능. <br />구동중에 Clear Inst Packet 을 받을경우, Status Packet의 Error 필드를 통해 Result Fail(0x01)을 전송. |
| 0x02 | -                                 | 사용하지 않음                                                                                                                                                                                                       |
| ...  | -                                 | 사용하지 않음                                                                                                                                                                                                       |
| 0xFF | -                                 | 사용하지 않음                                                                                                                                                                                                       |
