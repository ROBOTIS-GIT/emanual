...
**주의**: MX-64의 프로토콜 2.0 복구는, [다이나믹셀 위자드 2.0](/docs/kr/software/dynamixel/dynamixel_wizard2/#펌웨어-복구) 또는 [로보플러스 매니저 2.0](/docs/kr/software/rplus2/manager/#펌웨어-복구)의 펌웨어 복구 기능을 사용하세요. (프로토콜 2.0의 컨트롤 테이블은 [MX-64 (2.0) 컨트롤 테이블] 에서 확인 가능합니다.)
{: .notice--warning}
