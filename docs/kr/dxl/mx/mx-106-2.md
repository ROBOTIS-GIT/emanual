...
| 기어비           | 200 : 1                                                                                                                                                  |
| 정지 토크        | 8.0 [Nm] @ 11.1 [V], 4.8 [A]<br />8.4 [Nm] @ 12 [V], 5.2 [A]<br />10.0 [Nm] @ 14.8 [V], 6.3 [A]                                                          |
| 무부하 속도      | 41 [rev/min] @ 11.1 [V]<br />45 [rev/min] @ 12 [V]<br />55 [rev/min] @ 14.8 [V]                                                                          |
| 동작 온도        | -5 ~ +80 [&deg;C]                                                                                                                                        |
| 사용 전압        | 10 ~ 14.8 [V] (**권장 전압 : 12 [V]**)                                                                                                                   |
| 제어 명령        | Digital Packet                                                                                                                                           |
| 프로토콜 타입    | MX-106T: Half Duplex Asynchronous Serial Communication<br />MX-106R: RS485 Asynchronous Serial Communication<br />(8bit,1stop, No Parity)                |
| 통신 연결        | MX-106T: TTL Level Multidrop BUS<br />MX-106R: RS485 Multidrop BUS                                                                                       |
| ID               | 253 ID (0 ~ 252)                                                                                                                                         |
| 피드백           | Position, Temperature, Load, Input Voltage 등                                                                                                            |
| 재질             | Full Metal Gear<br />Metal(Front), Engineering Plastic(Middle, Back)                                                                                     |
| 대기 전류        | 100 [mA]                                                                                                                                                 |
