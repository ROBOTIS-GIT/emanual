...
| 제어 알고리즘 | PID Control                                                                                                                                             |
| 최소 제어각   | 0.088 [&deg;]                                                                                                                                           |
| 백래쉬        | 20 [arcmin] 또는 0.33 [&deg;]                                                                                                                           |
| 동작 모드     | 속도 제어 모드<br />위치 제어 모드(0 ~ 360 [&deg;])<br />확장 위치 제어 모드(멀티턴)<br />PWM 제어 모드                                                 |
| 무게          | MX-28AR/AT : 77 [g], MX-28R/T : 72 [g]                                                                                                                  |
| 크기          | 35.6 x 50.6 x 35.5 [mm]                                                                                                                                 |
| 기어비        | 193 : 1                                                                                                                                                 |
| 정지 토크     | 2.3 [Nm] @ 11.1 [V], 1.3 [A]<br />2.5 [Nm] @ 12 [V], 1.4 [A]<br />3.1 [Nm] @ 14.8 [V], 1.7 [A]                                                          |
| 무부하 속도   | 50 [rev/min] @ 11.1 [V]<br />55 [rev/min] @ 12 [V]<br />67 [rev/min] @ 14.8 [V]                                                                         |
| 동작 온도     | -5 ~ +80 [&deg;C]                                                                                                                                       |
| 사용 전압     | 10 ~ 14.8 [V] (**권장 전압 : 12 [V]**)                                                                                                                  |
| 제어 명령     | Digital Packet                                                                                                                                          |
| 프로토콜 타입 | MX-28T/MX-28AT: Half Duplex Asynchronous Serial Communication<br />MX-28R/MX-28AR: RS485 Asynchronous Serial Communication<br />(8bit,1stop, No Parity) |
| 통신 연결     | MX-28T/MX-28AT: TTL Level Multidrop BUS<br />MX-28R/MX-28AR: RS485 Multidrop BUS                                                                        |
| ID            | 253 ID (0 ~ 252)                                                                                                                                        |
| 피드백        | Position, Velocity, Temperature, Load, Input Voltage, Trajectory, Realtime Tick 등                                                                      |
| 재질          | Full Metal Gear<br />MX-28AR/AT: Metal(Front), Engineering Plastic(Middle, Back)<br />MX-28R/T: Engineering Plastic(Front, Middle, Back)                |
| 대기 전류     | 100 [mA]                                                                                                                                                |
