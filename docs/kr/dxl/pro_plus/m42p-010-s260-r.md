...
|:----:|:--------------:|:--------------------------------------------|:----:|:--------:|:----------------------------------:|:-----------------------:|
|  0   |       2        | [Model Number](#model-number)               |  R   |  2,100   |                 -                  |            -            |
...
|  40  |       4        | [Acceleration Limit](#acceleration-limit)   |  RW  |  1,0867  |           0 ~ 4,346,756            | 1 [rev/min<sup>2</sup>] |
...
+ FRP42-H120K Set
  ...
  ![](/assets/images/dxl/pro_plus/h42p_020_s300_r_03.png)

# [유지보수](#유지보수)

# [참고자료](#참고자료)

**NOTE** : [다이나믹셀 프로 호환가이드]{: .blank}  
[케이블 호환성]{: .popup}
{: .notice}
