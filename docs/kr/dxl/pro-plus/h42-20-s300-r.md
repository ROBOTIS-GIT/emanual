...
permalink: /docs/kr/dxl/pro_plus/h42-20-s300-r/
sidebar:
  title: H42-20-S300-R
  nav: "h42-20-s300-r"
---
...
|:----:|:--------------:|:------------------------------|:-------------|:----:|:------:|
|  0   |       2        | [Model Number](#model-number) | Model Number |  R   | 51201  |

{% include kr/dxl/control_table_0_pro_plus.md %}
