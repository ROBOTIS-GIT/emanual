...
| Link (Physical) | XM540-W270-T: TTL Level Multidrop BUS <br />XM540-W270-R: RS485 Multidrop BUS |
| ID |253 ID (0~252) |
...
| :---------: | :-----------:  | :----------- | :------------ | :--------: | :------------: |
|0|2|[Model Number](#model-number)                    |모델 번호                            |R  |1120|
...
|44|4|[Velocity Limit](#velocity-limit)               |속도 한계값                   |RW |278|
...
|58|1|[External Port Mode 3](#external-port)          |외부 확장포트 2 모드                     |RW |3|
...
|154|2|[External Port Data 2](#external-port-data)  |외부 확장포트 2 ㅏ값              |RW |-|
...
|580|2|[Indirect Address 30](#indirect-address)     |간접 주소 값30                        |RW |635|
|582|2|[Indirect Address 31](#indirect-address)     |간접 주소 값 31                        |RW |636|
|…|…|…|…|…|…|
|628|2|[Indirect Address 54](#indirect-address)     |간접 주소 값54                        |RW |659|
...
|Bit 1(0x02)|Master/Slave configuration(Dual joint)|Master mode(‘0’) : Master Dynamixel로 동작합니다.<br />Slave mode(‘1’) : Slave Dynamixel로 동작합니다.
...
[호환성 가이드]: http://en.robotis.com/service/compatibility_table.php?cate=dx
