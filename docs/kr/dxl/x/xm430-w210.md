...
| 기어비           | 212.6 : 1                                                                                                                                                                  |
| 스톨 토크        | 2.7 [N.m] @ 11.1 [V], 2.1 [A]<br />3.0 [Nm] @ 12.0 [V], 2.3 [A]<br />3.7 [Nm] @ 14.8 [V], 2.7 [A]                                                             |
| 무부하 속도      | 70 [rev/min] @ 11.1 [V]<br />77 [rev/min] @ 12.0 [V]<br />95 [rev/min] @ 14.8 [V]                                                                                                             |
| 동작 온도        | -5 ~ +80 [&deg;C]                                                                                                                                                         |
| 사용 전압        | 10.0 ~ 14.8 [V] (**권장 전압 : 12.0 [V]**)                                                                                                                                       |
| 제어 명령        | Digital Packet                                                                                                                                                           |
| 통신 타입        | XM430-W210-T (Half Duplex Asynchronous Serial Communication with 8bit, 1stop, No Parity)<br />XM430-W210-R (RS485 Asynchronous Serial Communication with 8bit, 1stop, No Parity) |
| 통신 연결         | XM430-W210-T (TTL Level Multi Drop Bus) <br /> XM430-W210-R (RS485 Multi Drop Bus)                                                                                       |
| ID               | 253 ID (0 ~ 252)                                                                                                                                                           |
...
| :---------: | :-----------:  | :----------- | :------------ | :--------: | :------------: |
|0|2|[Model Number](#model-number)                    |모델 번호                             |R  |1030|
...
|44|4|[Velocity Limit](#velocity-limit)               |속도 한계값                   |RW |480|
