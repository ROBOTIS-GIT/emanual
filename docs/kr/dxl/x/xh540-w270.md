...
노멀 혼은 다이나믹셀 정면의 출력축에 부착되어 있으며 베어링은 후면에 부착되어 있습니다.

![Horn_Assembly](/assets/images/dxl/x/X540/hn13-n101_assembly.png){: width="500"}

#### [노멀 혼 조립시 주의사항](#노멀-혼-조립시-주의사항)

쓰러스트 워셔의 위치를 알맞게 맞추세요. 그렇지 않을경우, 체결된 혼에 의해 쓰러스트 워셔가 손상 될 수 있습니다.  

![HowTo_Thrust_Washer](/assets/images/dxl/x/X540/thrust_washer_02.png){: width="500"}
...
프레임 보호를 위해, 스페이서 링을 사용하세요.  

![HowTo_SpacerRing](/assets/images/dxl/x/X540/howto_spacering_kr.png){: width="800"}
...
![Hinge_Assembly](/assets/images/dxl/x/X540/fr13-h101k.png){: width="850"}
...
**참고**: 힌지 프레임 조립 시, 백케이스에 아이들러 혼이 장착되어야합니다. [아이들러 조립하기](#아이들러-조립하기)를 참고하세요.
{: .notice}
...
![Side_Assembly_Side](/assets/images/dxl/x/X540/fr13-s101k.png){: width="850"}

> FR13-S101K

![Side_Assembly_Bottom](/assets/images/dxl/x/X540/fr13-s102k.png){: width="850"}
...
힌지프레임과 사이드 프레임을 활용하여 다양하게 활용 가능합니다. 
...
#### [Front (Wrench Bolt)](#option1-wrench-bolt)
...
1. Step 1
    ...
    ![ETC_FrameAssembly](/assets/images/dxl/x/X540/x540_etc_assembly_example_front2_01.png){: width="650"}

2. Step 2

    ![ETC_FrameAssembly](/assets/images/dxl/x/X540/x540_etc_assembly_example_front2_02.png){: width="650"}
...
#### [Side](#side)
  ...
  ![ETC_FrameAssembly](/assets/images/dxl/x/X540/x540_etc_assembly_example_side.png){: width="650"}
  
  {% capture sidetab_warning_3mm %}
  **주의**: 케이스 측면 (Side Tab)에 프레임 결합 시, 나사 길이에 유의하세요.  
  
  ![3mm_Mount_Deep_Warning](/assets/images/dxl/x/X540/3mm_mount_warning.jpg){: width="700"}  
...
#### [Bottom](#bottom)
  ...
  ![ETC_FrameAssembly](/assets/images/dxl/x/X540/x540_etc_assembly_example_bottom.png){: width="650"}
