...
실제 구동을 위해 로봇을 설계하신다면 Stall Torque의 1/5 이하의 로드가 걸리도록 설계하셔야 안정적인 움직임이 가능합니다.
{: .notice}
...
|3|1|[ID](#id)                  |다이나믹셀 ID     |RW|1|0|252|
|4|1|[Baud Rate](#baud-rate)           |다이나믹셀 통신 속도|RW|3|0|3|
