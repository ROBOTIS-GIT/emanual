...
| Link (Physical)| XH430-W350-T: TTL Level Multidrop BUS <br />XH430-W350-R: RS485 Multidrop BUS |
| ID | 253 ID (0~252) |
...
| :---------: | :-----------:  | :----------- | :------------ | :--------: | :------------: |
|0|2|[Model Number](#model-number)                    |모델 번호                            |R  |1000|
...
|44|4|[Velocity Limit](#velocity-limit)               |속도 한계값                   |RW |280|
