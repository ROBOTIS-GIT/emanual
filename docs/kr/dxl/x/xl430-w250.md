...
### 신형 XL430-W250
<<<<<<< HEAD
- `다운로드` [New XL430.pdf]{: .blank}
- `다운로드` [New XL430.dwg]{: .blank}
- `다운로드` [New XL430.stp]{: .blank}
=======
- `다운로드` [XL430_new(pdf).pdf]{: .blank}
- `다운로드` [XL430_new(dwg).dwg]{: .blank}
- `다운로드` [XL430_new(stp).stp]{: .blank}
>>>>>>> 1e4dc204fefd37060d39dc5d3b0ef53cf02312c2
...
<<<<<<< HEAD
[New XL430.pdf]: http://www.robotis.com/service/download.php?no=772
[New XL430.dwg]: http://www.robotis.com/service/download.php?no=771
[New XL430.stp]: http://www.robotis.com/service/download.php?no=773
=======
