...
|:----:|:--------------:|:--------------------------------------------|:--------------------|:----:|:------:|:----------------------------:|:------:|
|  0   |       2        |[Model Number](#model-number)                | 모델 번호            |  R   | 43,289  |              -               | - |
...
|  44  |       4        | [Velocity Limit](#velocity-limit)           | 최대 속도 값         |  RW  |  2,600 |          0 ~ 2,600           | 0.01 [rev/min] |
...
|각도|위치값|방향|
| :--------: | :--------: |:--------:|
| -180 [&deg;]<hr>0 [&deg;]<hr>180 [&deg;]|-263,187<hr>0<hr>263,187|![](/assets/images/dxl/pro/angle_direction.png)|
