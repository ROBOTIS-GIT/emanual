...
permalink: /docs/kr/dxl/pro/m42-10-s260-r(a)/
sidebar:
...
|:----:|:--------------:|:--------------------------------------------|:--------------------|:----:|:------:|:----------------------------:|:------:|
|  0   |       2        |[Model Number](#model-number)                | 모델 번호            |  R   | 43289  |              -               | - |
...
|  38  |       2        | [Current Limit](#current-limit)             | 최대 한계 전류       |  RW  |  1,461 |          0 ~ 1,461          | 1 [mA] |
|  40  |       4        | [Acceleration Limit](#acceleration-limit)   | 가속도 최대 값       |  RW  | 10,867 |          0 ~ 4,346,756      | 1 [rev/min²] |
|  44  |       4        | [Velocity Limit](#velocity-limit)           | 최대 속도 값         |  RW  |  2,600 |          0 ~ 2600           | 0.01 [rev/min] |
|  48  |       4        | [Max Position Limit](#max-position-limit)   | 최대 위치 제한 값    |  RW  | 262,931 | -263,187 ~<br> 263,187     | 1 [Pulse] |
|  52  |       4        | [Min Position Limit](#min-position-limit)   | 최소 위치 제한 값    |  RW  |-262,931 | -263,187 ~<br> 263,187     | 1 [Pulse] |
