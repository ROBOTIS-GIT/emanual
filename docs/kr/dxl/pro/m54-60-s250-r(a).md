...
permalink: /docs/kr/dxl/pro/m54-60-s250-r(a)/
sidebar:
...
|:----:|:--------------:|:--------------------------------------------|:--------------------|:----:|:------:|:----------------------------:|:------:|
|  0   |       2        | [Model Number](#model-number)               | 모델 번호            |  R   | 46353  |              -               | - |
...
|  38  |       2        | [Current Limit](#current-limit)             | 최대 한계 전류       |  RW  |  7,980 |          0 ~ 7,980          | 1 [mA] |
|  40  |       4        | [Acceleration Limit](#acceleration-limit)   | 가속도 최대 값       |  RW  | 11,145 |          0 ~ 4,457,932      | 1 [rev/min²] |
|  44  |       4        | [Velocity Limit](#velocity-limit)           | 최대 속도 값         |  RW  |  2,830 |          0 ~ 2830           | 0.01 [rev/min] |
