...
| 내부 I/O 장치 |                                버튼 : 2 (MODE, START)<br />마이크 (소리 감지) : 1<br />부저 : 1<br />전압 센서 : 1<br />자이로 가속도 센서 : 1<br />RGB LED : 3                                |
...
원격으로 스마트 기기에서 제어기로 태스크파일(.tsk3)을 다운로드할 수 있습니다.  

1. 제어기가 스마트 기기와 연결된 상태에서, 로보플러스 태스크 3앱의 홈탭에서 **태스크 예제** 를 클릭하여 제품을 선택해주세요.
...
**참고** : `ENGINEER 실험실`의 자료 및 각종 기능은 예고없이 변경될 수 있습니다.  
{: .notice--info}
