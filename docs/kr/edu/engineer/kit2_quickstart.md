...
## [앱 설치하기](#앱-설치하기)
- 엔지니어 키트 1의 [앱 설치하기](/docs/kr/edu/engineer/kit1/#작동하기)를 참조하세요
...
PC로 작성한 예제 또는 다운로드 받은 예제를 제어기에 다운로드 하는 방법입니다. 순서대로 진행하세요.
...
스마트기기에서 작성한 예제 또는 다운로드 받은 예제를 제어기에 원격으로 다운로드 하는 방법입니다. 순서대로 진행하세요.
