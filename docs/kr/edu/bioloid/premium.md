...
### 휴머노이드 활용 예제
기본예제로 STEAMCUP PREMIUM에 제공되는 보행 속도의 2배 이상의 속도를 내는 보행 동작과 격투 경기용 동작이 포함되어 있습니다.
...
STEAMCUP PREMIUM 혹은 STEAMCUP GP 에서는 CM-530의 센서연결부를 통해 [적외선 센서]와 [접촉 센서]를 추가로 달 수 있습니다.
...
### 그리퍼 재료
- STEAMCUP PREMIUM을 이용하여 휴머노이드  B타입과 C타입은 AX-12+가 2개의 여유가 생깁니다.
