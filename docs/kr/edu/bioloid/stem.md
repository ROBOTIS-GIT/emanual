...
|로봇 사진|설명|
|:----:|:----|
|1. 순차명령로봇<br />![](/assets/images/edu/bioloid/stem_beebot_KR.jpg)|[Download][BIO_STEM_SequenceRacer1_KR.tsk] 기본단계<br/>[Download][BIO_STEM_SequenceRacer2_KR.tsk] 응용단계<br/>[Download][BIO_STEM_SequenceRacer3_KR.tsk] 실전단계<br />[Download](https://www.dropbox.com/s/oyfw0kb58iz9kri/BIO_STEM_SequenceRacer.wmv?dl=0) 동영상<br />- `다이나믹셀 설정 값`<br />AX-12W ID[1], ID[2] : 바퀴모드<br />- `알고리즘`<br />제어기의 버튼으로 로봇의 이동 방향을 제어<br/>- `동작방법`<br/>직진(U), 좌회전(L), 우회전(R), 후진(D) 명령을 순차적으로 입력하고 실행(START) 버튼을 누르면 입력 순서에 따라 이동|
