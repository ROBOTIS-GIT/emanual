...
This class loads control table in file of Dynamixel item.
...
**begin** function set PortHandler and **scan** function set PacketHandler and ping all Dynamixels.
...
**begin** function set an portHandler and **ping** function get an item of connected Dynamixel.  
