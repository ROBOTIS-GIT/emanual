...
- Firmware Recovery to CM-151 can be performed using [R+ Manager] (v1.0.30.0 or higher) or [R+ Manager 2.0].
- Control connected components using Task programming such as [R+ Task](v1.1.0.0 or higher) or [R+ Task 2.0](/docs/en/software/rplus2/task/)
...
- Press the "Start button" the POWER LED turns on and the controller runs one downloaded program
...
- CM-151 is capable of BLE communication, therefore is compatible with BT-410 Dongle.
