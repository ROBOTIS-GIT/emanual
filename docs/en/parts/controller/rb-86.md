...
- Connect the RB-86 controller in Recovery mode by clicking "Add Robot" in the STEAMCUP app. ([Connect from Mobile](https://emanual.robotis.com/docs/en/parts/controller/rb-86/#connect-from-mobile))
