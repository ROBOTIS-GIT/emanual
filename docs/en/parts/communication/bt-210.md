...
<div style="notice--warning">{{ bt-210_warning_01 | markdownify }}</div>
...
Uutilizes a pairing mechanism that allows reliable 1:1 communication.
...
## [BT-210 Pairing Setting](#bt-210-pairing-setting)
...
5. From terminal check the box and press OK  From there enter the AT and enter an integer. The OK button becomes available and will allow check of the BT-210.

    ![](/assets/images/parts/communication/bt-210_07.png)

6. Once setup is complete when the BT-210 is connected to the CM-900 pick either master or slave mode The picture show master mode.
