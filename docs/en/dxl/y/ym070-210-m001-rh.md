...
{% include en/dxl/control_table/control_table.md %}
...
| 40    | 1         | EEPROM | [In-Position Threshold](#in-position-threshold)                         | RW   | 1,000     | 0 ~ 2,147,483,647              | 1 [pulse]         |
...
| 57    | 2         | EEPROM | [Motor Temperature Limit](#motor-temperature-limit)                     | RW   | 80        | 0 ~ 100                        | 1 [°C]            |
...
{% include en/dxl/control_table/velocity_limit.md %}
...
{% include en/dxl/control_table/position_limit.md %}
...
{% include en/dxl/control_table/electronic_gear_ratio_numerator.md %}

### <a name="torque-on-off-timing-chart"></a>**[Torque ON-OFF Timing Chart](#torque-on-off-timing-chart)**

{% include en/dxl/control_table/torque_on_off_timing_chart.md %}

### <a name="safe-stop-time"></a>**[Safe Stop Time(104)](#safe-stop-time104)**

{% include en/dxl/control_table/safe_stop_time.md %}
...
{% include en/dxl/control_table/brake_delay.md %}
...
{% include en/dxl/control_table/velocity_gain.md %}
...
{% include en/dxl/control_table/position_gain.md %}
...
{% include en/dxl/control_table/profile_acceleration.md %}
...
{% include en/dxl/control_table/profile_acceleration_time.md %}

### <a name="torque-enable"></a>**[Torque Enable(512)](#torque-enable512)**

{% include en/dxl/control_table/torque_enable.md %}

### <a name="led"></a>**[LED(513)](#led513)**

{% include en/dxl/control_table/led.md %}
