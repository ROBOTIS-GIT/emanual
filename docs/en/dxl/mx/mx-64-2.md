...
| Operation Modes | Current Control Mode<br />Velocity Control Mode<br />Position Control Mode(0&deg; ~ 360&deg;)<br />Extended Position Ctrl Mode(Multi-turn)<br />Current-based Position Control Mode<br />PWM Control Mode |
...
| Physical Connection | MX-64T/MX-64AT: TTL Level Multi Drop BUS<br />MX-64R/MX-64AR: RS485 Multidrop BUS |
| ID | 0 ~ 252 |
...
This is a target position trajectory created by Profile. This value is only used in Position Control Mode, Extended Position Control Mode. For more details, please refer to the [Profile Velocity(112)](#profile-velocity).
...
This value indicates internal temperature of Dynamixel. For more details, please refer to the [Temperature Limit(31)](#temperature-limit).
