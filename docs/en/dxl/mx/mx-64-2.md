...
1. An Instruction from the user is transmitted viDYNAMIXEL bus, then registered to Goal Position(116).
...
<iframe width="560" height="315" src="https://youtu.be/mAm_9C1MoAs" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
