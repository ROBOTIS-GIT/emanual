...
**NOTE** : In order to use Protocol 2.0, please recover the firmware to Protocol 2.0 from Protocol 1.0 using **Firmware Recovery** in the [DYNAMIXEL Wizard 2.0](/docs/en/software/dynamixel/dynamixel_wizard2/#firmware-recovery) or [R+ Manager](/docs/en/software/rplus2/manager/#firmware-recovery). 
{: .notice}
