...
![](/emanual/assets/images/dxl/mx/mx-106r_product.png)
![](/emanual/assets/images/dxl/mx/mx-106t_product.png)
...
![](/emanual/assets/images/dxl/mx/mx-106_ntgraph.jpg)
...
`Caution` Data in the EEPROM Area can only be changed or modified when the value of Torque Enable(64) is cleared to ‘0’.
{: .notice--warning}
...
{% include dxl/control_table_dual_drivemode.md %}
...
| Unit | Value Range     |
| :---: | :------------: |
|about  3.36[mA]|0 ~ Current Limit(38)|
...
{% include dxl/control_table_velocity_trajectory.md %}

### <a name="position-trajectory"></a>**Position Trajectory(140)**
{% include dxl/control_table_position_trajectory.md %}

### <a name="present-input-voltage"></a>**Present Input Voltage(144)**
{% include dxl/control_table_present_volt_2.md %}

### <a name="present temperature"></a>**Present Temperature(146)**
{% include dxl/control_table_present_temp_2.md %}
...
![](/emanual/assets/images/dxl/mx/mx-106+_fr05-f101_fr08-x101.png)

+ FR05-S101
![](/emanual/assets/images/dxl/mx/mx-106+_fr05-s101.png)

+ FR08-B101
![](/emanual/assets/images/dxl/mx/mx-106+_fr08-b101.png)

+ FR08-H101
![](/emanual/assets/images/dxl/mx/mx-106+_fr08-h101.png)

+ FR08-H110 and FR08-D101
![](/emanual/assets/images/dxl/mx/mx-106+_fr08-h110_fr08-d101.png)

## Horns

+ HN05-N102
![](/emanual/assets/images/dxl/mx/mx-106+_hn05-t101.png)
