...
| Physical Connection | MX-106T: TTL Level Multi Drop BUS<br />MX-106R: RS485 Multidrop BUS |
| ID | 0 ~ 253 |
...
### <a name="drive-mode"></a>**Drive Mode**

|Bit|Item|Description|
| :---: | :---: | :---: |
|Bit 2 ~ 7|N/A|-|
|Bit 1|Master/Slave Mode|0: Master Mode<br />1 : Slave Mode|
|Bit 0|Normal/Reverse Mode|0: Normal Mode, In case of 1: Reverse mode
Master Mode
...
Notes : Reverse mode is to change the actual rotation direction reversely.  It can be used conveniently when the robot with symmetrical joints layout is built.
...
`Download` [MX-106T](http://support.robotis.com/en/baggage_files/dynamixel/mx-106t.pdf)
`Download` [MX-106R](http://support.robotis.com/en/baggage_files/dynamixel/mx-106r.pdf)

[Update firmware]: ???

[MX-106(2.0) Control Table]: ???
