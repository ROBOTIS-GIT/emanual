...
| Gear Ratio | 353.5 : 1  |
| Stall Torque | 3.3Nm @ 24V, 0.7A |
| No Load Speed | 31rpm @ 24V |
...
![](/emanual/assets/images/dxl/x/xh430_v350_performance_graph.jpg)
...
| :------------- | :------------- | :------------- | :------------- | :------------- | :------------- |
|0|2|[Model Number](#model-number)                    |Model Number                             |R  |1040|
...
{% include dxl/control_table_volt_limit_24v.md %}
...
| Unit | Value Range     |
| :---: | :------------: |
|about  1.34[mA]|0 ~ Current Limit(38)|
