...
**CAUTION** : Each motor on 2XL430 has its own control table. However the value of [Baud Rate(8)] and [Protocol Version(13)] is always changed at the same time because there is only one communication module in the actuator.  
