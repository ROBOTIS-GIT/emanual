...
permalink: /docs/en/dxl/x/xm335-t323/
sidebar:
  title: XM335-T323-T
  nav: "xm335-t323"
product_group: xm335
...
![](/assets/images/dxl/x/x335/xm335-series_product.png)
...
![](/assets/images/dxl/x/x335/xm335-t323_performance_graph.jpg)
...
|:-------:|:--------------:|:------------------------------------------------|:-------|:-------------------|:--------------------------|:----------------|
|    0    |       2        | [Model Number](#model-number)                   | R      | 1,701              | -                         | -               |
...
### <a name="max-voltage-limit"></a><a name="min-voltage-limit"></a>**[Min/Max Voltage Limit(34, 32)](#minmax-voltage-limit32-34)**
...
<!--
The XM335 forwards the PWM duty will be linearly interpolated with a set slope by PWM Slope(62) to the motor's inverter
 -->
...
**NOTE** :
- Current Limit(38) may differ by each DYNAMIXEL so please check the Control Table.
- XM335 series measures curret at its input power source unlike other DYNAMIXEL-X series supporting a current control. Therefore, you may have a different results in measuring current of XM335 series comparing with measuring phase current which quickly changes of a DC motor.
{% endcapture %}
<div class="notice">{{ current_limit_note | markdownify }}</div>
...
{% include en/dxl/drawing/x335_drawing.md %}
...
{% include en/dxl/hrs_ttl.md %}

{% include en/dxl/ttl_connection_x.md %}

## [Drawings](#drawings)

- `Download` [XM335.pdf]{: .blank}
- `Download` [XM335.dwg]{: .blank}
- `Download` [XM335.stp]{: .blank}

{% include en/dxl/download_center_notice.md %}

[XM335.pdf]: https://www.robotis.com/service/download.php?no=1986
[XM335.dwg]: https://www.robotis.com/service/download.php?no=1985
[XM335.stp]: https://www.robotis.com/service/download.php?no=1987
