...
### <a name="external-port-mode"></a>**[External Port Mode](#external-port-mode)**
### <a name="external-port-data"></a>**[External Port Data](#external-port-data)**
...
### <a name="indirect-address"></a>**[Indirect Address](#indirect-address)**
### <a name="indirect-data"></a>**[Indirect Data](#indirect-data)**
...
### <a name="velocity-i-gain"></a>**[Velocity PI Gain(524, 526)](#velocity-pi-gain524-526)**
### <a name="velocity-p-gain"></a>**[Feedforward 2nd Gains(536)](#feedforward-2nd-gains536)**
...
### **[Feedforward 1st Gains(538)](#feedforward-1st-gains538)**
...
|:------------------:|:------------------:|:-----------------------------------------------:|
| -180 ~ 180 [&deg;] | -501,923 ~ 501,923 | ![](/assets/images/dxl/pro/angle_direction.png) |
