...
|:----:|:----------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0x01 | Fixed Values<br />(0x44 0x58 0x4C 0x22) | Reset a current Present Position value to an absolute value within one full rotation (0-4096). <br />The Clear instruction can only be applied when DYNAMIXEL is stopped.<br />Note that if DYNAMIXEL is in motion and the Clear Instruction packet is sent, Result Fail (0x01) will be sent via the Error field of the Status Packet. |
| 0x02 | -                                       | Reserved                                                                                                                                                                                                     |
| ...  | -                                       | Reserved                                                                                                                                                                                                     |
| 0xFF | -                                       | Reserved                                                                                                                                                                                                     |
