...
permalink: /docs/en/dxl/pro_plus/ph54-100-s500-r/
sidebar:
...
![](/assets/images/dxl/pro_plus/ph54-100-s500-r.png)
...
|:-------:|:--------------:|:--------------------:|:--------------------------------------------|:------:|:------------------:|:----------------------------------:|:-----------------------:|
|    0    |       2        | *40001*             | [Model Number](#model-number)               |   R    |       2,010        |                 -                  |            -            |
...
|   13    |       1        | *40007 (Lo Byte)*   | [Protocol Type](#protocol-type13)           |   RW   |         2          |                2, 10                 |            -            |
...
|   38    |       2        | *40020*             | [Current Limit](#current-limit)             |   RW   |       15,900       |             0 ~ 15,900             |         1 [mA]          |
|   40    |       4        | *40021*             | [Acceleration Limit](#acceleration-limit)   |   RW   |       10,639       |           0 ~ 4,255,632            | 1 [rev/min<sup>2</sup>] |
