...
| Address | Size<br>[Byte] | *Modbus<br>(Size[Word])* |                  Data Name                  | Access | Initial<br />Value |               Range                |          Unit           |
|:-------:|:--------------:|:-------------------------|:-------------------------------------------:|:------:|:------------------:|:----------------------------------:|:-----------------------:|
|    0    |       2        | *40001 (1)*              |        [Model Number](#model-number)        |   R    |       2,020        |                 -                  |            -            |
|    2    |       4        | *40002 (2)*              |   [Model Information](#model-information)   |   R    |         -          |                 -                  |            -            |
...
|   13    |       1        | *40007 (Hi Byte)*        |       [Protocol Mode](#protocol-mode)       |   RW   |         2          |                1~2                 |            -            |
|   20    |       4        | *40011 (2)*              |       [Homing Offset](#homing-offset)       |   RW   |         0          | -2,147,483,648 ~<br> 2,147,483,647 |        1 [pulse]        |
|   24    |       4        | *40013 (2)*              |    [Moving Threshold](#moving-threshold)    |   RW   |         50         |             0 ~ 2,900              |     0.01 [rev/min]      |
|   31    |       1        | *40016 (Hi Byte)*        |   [Temperature Limit](#temperature-limit)   |   RW   |         80         |              0 ~ 100               |       1 [&deg;C]        |
|   32    |       2        | *40017 (1)*              |   [Max Voltage Limit](#max-voltage-limit)   |   RW   |        350         |              0 ~ 350               |         0.1 [V]         |
|   34    |       2        | *40018 (1)*              |   [Min Voltage Limit](#min-voltage-limit)   |   RW   |        150         |              0 ~ 350               |         0.1 [V]         |
|   36    |       2        | *40019 (1)*              |           [PWM Limit](#pwm-limit)           |   RW   |       2,009        |             0 ~ 2,009              |            -            |
|   38    |       2        | *40020 (1)*              |       [Current Limit](#current-limit)       |   RW   |       22,740       |             0 ~ 22,740             |         1 [mA]          |
|   40    |       4        | *40021 (2)*              |  [Acceleration Limit](#acceleration-limit)  |   RW   |       9,982        |           0 ~ 3,992,644            | 1 [rev/min<sup>2</sup>] |
|   44    |       4        | *40023 (2)*              |      [Velocity Limit](#velocity-limit)      |   RW   |       2,900        |             0 ~ 2,900              |     0.01 [rev/min]      |
|   48    |       4        | *40025 (2)*              |  [Max Position Limit](#max-position-limit)  |   RW   |      501,433       |       -501,923 ~<br> 501,923       |        1 [pulse]        |
|   52    |       4        | *40027 (2)*              |  [Min Position Limit](#min-position-limit)  |   RW   |      -501,433      |       -501,923 ~<br> 501,923       |        1 [pulse]        |
...
|   168   |       2        | *40085 (1)*              |   [Indirect Address 1](#indirect-address)   |   RW   |        634         |            512 ~ 1,023             |            -            |
|   170   |       2        | *40086 (1)*              |   [Indirect Address 2](#indirect-address)   |   RW   |        635         |            512 ~ 1,023             |            -            |
|   172   |       2        | *40087 (125)*            |   [Indirect Address 3](#indirect-address)   |   RW   |        636         |            512 ~ 1,023             |            -            |
|   ...   |      ...       |                          |                     ...                     |  ...   |        ...         |                ...                 |           ...           |
|   422   |       2        | *40212 (1)*              |  [Indirect Address 128](#indirect-address)  |   RW   |        761         |            512 ~ 1,023             |            -            |
