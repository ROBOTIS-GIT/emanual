...
permalink: /docs/en/platform/ros2_openmanipulator_pro/ros_operation/
sidebar:
...
**Warning!**     
When launching the controller to use MoveIt!, [OpenMANIPULATOR-PRO launch file](/docs/en/platform/ros2_openmanipulator_pro/ros_controller_package/#launch-controller) must be turned off.
{: .notice--warning}
