...
OpenMANIPULATOR-PRO RM-P60-RNH is composed of [DYNAMIXEL-P series](/docs/en/dxl/p/). DYNAMIXEL has a modular form and adopts the daisy chain method. It allows users to easily add or remove joints for their own use.  
