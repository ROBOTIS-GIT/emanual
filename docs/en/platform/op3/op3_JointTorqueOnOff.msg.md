### File: [`op3_offset_tuner_msgs/JointTorqueOnOff.msg`](https://github.com/ROBOTIS-GIT/ROBOTIS-OP3-msgs/blob/master/op3_offset_tuner_msgs/msg/JointTorqueOnOff.msg)
### Message Definition
```
string  joint_name
bool    torque_enable
