...
![](/assets/images/sw/rplus_task3_en/port_nickname_01.png)  

The following is an example of using the Port Nickname.  

![](/assets/images/sw/rplus_task3_en/port_nickname_02.png)  
![](/assets/images/sw/rplus_task3_en/port_nickname_03.png)
...
- **Power** : The value ranges from 0 to 1023, where 0 means stop and 1023 is 100% power capacity.  
  ![](/assets/images/sw/rplus_task3_en/task3_070.png)

The following example is controlling the geared motor.

![](/assets/images/sw/rplus_task3_en/task3_071.png)

The following example is using the geared motor to move the robot forward.

![](/assets/images/sw/rplus_task3_en/task3_072.png)
...
- User can turn on/off the Right LED or Left LED.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_077.png)

The following is an example of controlling the LED module.

![](/assets/images/sw/rplus_task3_en/task3_078.png)
...
- The following is an example of using the touch sensor.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_079.png)
...
- The following is an example of using the infrared sensor.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_080.png)
...
- The following is an example of using the magnetic sensor.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_084.png)
...
- The following is an example of using the temperature sensor.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_085.png)
...
- The following is an example of using the motion detection sensor.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_086.png)
...
- The following is an example of using the temperature and humidity sensor.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_087.png)
...
- The following is an example of using the illuminance sensor.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_088.png)
...
- The following is an example of using the user device.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_089.png)
...
![](/assets/images/sw/rplus_task3_en/task3_090.png)
...
![](/assets/images/sw/rplus_task3_en/task3_091.png)
...
![](/assets/images/sw/rplus_task3_en/task3_099.png)
...
![](/assets/images/sw/rplus_task3_en/task3_100.png)

The following is an example of using buttons for OpenCM9.04.

![](/assets/images/sw/rplus_task3_en/task3_101.png)
...
![](/assets/images/sw/rplus_task3_en/task3_096.png)
...
![](/assets/images/sw/rplus_task3_en/task3_097.png)
...
![](/assets/images/sw/rplus_task3_en/task3_098.png)
...
![](/assets/images/sw/rplus_task3_en/task3_102.png)
...
![](/assets/images/sw/rplus_task3_en/task3_103.png)
...
![](/assets/images/sw/rplus_task3_en/task3_104.png)
...
![](/assets/images/sw/rplus_task3_en/task3_113.png)
...
![](/assets/images/sw/rplus_task3_en/task3_114.png)

#### Delay
CM-550 supports `Delay` function that can simplifies the combined usage of `Timer` and `WAIT WHILE`.

![](/assets/images/sw/rplus_task3_en/cm550_delay_01.png)

![](/assets/images/sw/rplus_task3_en/cm550_delay_02.png)  

The following is an example of replacing `Timer` and `WAIT WHILE` with `Delay` function with CM-550.

![](/assets/images/sw/rplus_task3_en/cm550_delay_03.png)
...
![](/assets/images/sw/rplus_task3_en/task3_115.png)
...
![](/assets/images/sw/rplus_task3_en/task3_116.png)
...
![](/assets/images/sw/rplus_task3_en/task3_117.png)
...
![](/assets/images/sw/rplus_task3_en/task3_118.png)  
![](/assets/images/sw/rplus_task3_en/task3_119.png)
...
![](/assets/images/sw/rplus_task3_en/task3_216.png)
...
![](/assets/images/sw/rplus_task3_en/task3_120.png)
...
The `Position Value` control can be used to designate the angle position as shown below.  
  ![](/assets/images/sw/rplus_task3_en/task3_121.png)
...
The `Speed Value` control can be used to designate the rotation direction and power value as shown below.  
  ![](/assets/images/sw/rplus_task3_en/task3_122.png)
...
![](/assets/images/sw/rplus_task3_en/task3_214.png)
...
![](/assets/images/sw/rplus_task3_en/task3_123.png)
...
![](/assets/images/sw/rplus_task3_en/task3_217.png)
...
![](/assets/images/sw/rplus_task3_en/task3_124.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_126.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_129.png)
...
![](/assets/images/sw/rplus_task3_en/task3_130.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_132.png)
...
![](/assets/images/sw/rplus_task3_en/task3_133.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_135.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_137.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_139.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_142.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_144.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_146.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_148.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_151.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_156.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_161.png)
...
![](/assets/images/sw/rplus_task3_en/task3_162.png)
...
![](/assets/images/sw/rplus_task3_en/task3_163.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_166.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_170.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_173.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_176.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_178.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_181.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_184.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_187.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_190.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_192.png)
...
![](/assets/images/sw/rplus_task3_en/task3_193.png)
...
![](/assets/images/sw/rplus_task3_en/task3_194.png)  
...
![](/assets/images/sw/rplus_task3_en/task3_202.png)
...
- The following is an example of using a variable.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_203.png)
...
- The valid value range is -2,147,483,648 ~ 4,294,967,295.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_204.png)
...
- False: 0, True: 1.
  ...
  ![](/assets/images/sw/rplus_task3_en/task3_205.png)
...
![](/assets/images/sw/rplus_task3_en/task3_218.png)
