...
|6. Motorcycle<br />![Ex_06][img_adv_ex_06]|[Download][adv_ex_13-1] Basic Phase<br />[Download][adv_ex_13-2] Application Phase<br />[Download][adv_ex_13-3] Practical Phase<br />[Download][adv_ex_13-4] Video<br /> `Dynamixel Setting`<br />AX-12W ID[1]: Wheel Mode, AX-12W ID[2]: Joint Mode<br />`Algorithm`<br />Control action by following the black line and avoiding obstacles<br />`Operation Guide`<br />Follows the line while avoiding obstacles by steering itself away from such obstacle.|
